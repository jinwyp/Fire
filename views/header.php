...
<html>
<head>
	<title><?php echo isset($title)?$title.' - Fire':'Fire'; ?></title>
	...
	<link rel="shortcut icon" href="static/image/fire-black.png" type="image/png" />
	<link rel="apple-touch-icon" href="static/image/fire-black.png" />
